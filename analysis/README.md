...
predictions, and extracts peptide-MHC distance maps from predicted structures. AlphaFold-
Multimer structures are generated through ColabFold, and results are processed to generate 
continuous and binary interface representations. 
